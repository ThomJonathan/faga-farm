    ...
    <div className="relative" ref={searchRef}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full sm:w-80 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 placeholder-gray-500"
        />
        {query && (
          <button
            onClick={() => {
